...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataf', default='data_transform/cifar10', help='where to save transformed result')
    ...
    torch.save(data[0], '{}/cifar10_transform.pt'.format(args.dataf))
