...
nit = 20100  # number of iterations
...
barycenter = SinkhornBarycenterWeight(source_distribution_weights, source_distribution_supports, barycenter_initial_weight, barycenter_initial_support, step_size, backend=backend)
fig = plt.figure()
ax = fig.gca()
