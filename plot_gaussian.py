...
for SD_nparticle in SD_nparticles:
    data = np.loadtxt(os.path.join(plot_save_path, "SD_gaussian_nparticle{}".format(SD_nparticle)))
...
for FW_nparticle in FW_nparticles:
    data = np.loadtxt(os.path.join(plot_save_path, "FW_gaussian_nparticle{}".format(FW_nparticle)))
...
plt.savefig(os.path.join(plot_save_path, 'gaussian.pdf'))
# plt.show()
