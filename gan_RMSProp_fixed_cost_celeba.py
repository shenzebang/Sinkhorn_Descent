...
if __name__ == '__main__':
    ...
    c_encoder.load_state_dict(torch.load('{}/c_encoder_{}.pt'.format(args.modelf, 40)))

    optimizerμ = optim.RMSprop(μ_decoder.parameters(), lr=args.lr_decoder)
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(result, '{}/rmsprop.pt'.format(args.plotf))
